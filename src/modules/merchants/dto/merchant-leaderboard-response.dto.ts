...
export class MerchantLeaderboardEntryDto {
  ...
  @ApiProperty({
    description: 'Financial score derived from repayment rate, default rate and volume.',
    example: 87,
  })
  score: number;

  @ApiProperty({
    description: 'Tier derived from the financial score.',
    example: 'silver',
...
export class MerchantLeaderboardResponseDto {
  @ApiProperty({
    description: 'Metric used to rank the merchants below.',
