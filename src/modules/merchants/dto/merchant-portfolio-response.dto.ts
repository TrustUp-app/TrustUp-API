...
export class MerchantPortfolioLoanDto {
  @ApiProperty({
    description: 'Internal UUID of the loan.',
...
export class MerchantPortfolioResponseDto {
  ...
  @ApiProperty({
    description: 'Total loan volume in USD across the merchant lifetime.',
    example: 25000,
  })
  totalVolume: number;

  @ApiProperty({
    description: 'Sum of remaining balances across active loans, in USD.',
    example: 4200,
  })
  ...
  @ApiProperty({
    type: [MerchantPortfolioLoanDto],
    description: 'Paginated list of the merchant active loans.',
  })
