...
export class UserProfileDto {
  ...
  @ApiProperty({
    ...
    nullable: true,
    description: 'Display name, null until set via PATCH /users/me',
  })
  name: string | null;
  ...
  @ApiProperty({
    ...
    nullable: true,
    description: 'Avatar URL (https only), null until set',
  })
  avatar: string | null;
  ...
  @ApiProperty({
    ...
    description: 'User role for RBAC (admin, merchant, lp_provider, borrower)',
  })
  role: UserRole;
